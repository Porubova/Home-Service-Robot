...
(cl:defmethod cl:initialize-instance :after ((m <DriveToTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveToTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wall_follower-srv:<DriveToTarget-request> is deprecated: use wall_follower-srv:DriveToTarget-request instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wall_follower-srv:linear_x-val is deprecated.  Use wall_follower-srv:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wall_follower-srv:angular_z-val is deprecated.  Use wall_follower-srv:angular_z instead.")
  (angular_z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveToTarget-request>)))
  ...
  "wall_follower/DriveToTargetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveToTarget-request)))
  "Returns string type for a service object of type 'DriveToTarget-request"
  "wall_follower/DriveToTargetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <DriveToTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveToTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wall_follower-srv:<DriveToTarget-response> is deprecated: use wall_follower-srv:DriveToTarget-response instead.")))

(cl:ensure-generic-function 'msg_feedback-val :lambda-list '(m))
(cl:defmethod msg_feedback-val ((m <DriveToTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wall_follower-srv:msg_feedback-val is deprecated.  Use wall_follower-srv:msg_feedback instead.")
  (msg_feedback m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveToTarget-response>)))
  ...
  "wall_follower/DriveToTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveToTarget-response)))
  "Returns string type for a service object of type 'DriveToTarget-response"
  "wall_follower/DriveToTargetResponse")
